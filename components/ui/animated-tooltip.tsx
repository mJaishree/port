      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <img
            ...
            alt={item.name}
            className={cn(
              "object-cover !m-0 !p-0 object-top rounded-full h-14 w-14 border-2 group-hover:scale-105 transition duration-200",
              hoveredIndex === idx ? "border-white" : "border-[#adcdd4]/50",
            )}
          />
        </div>
      ))}
