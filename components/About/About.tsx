      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-[#adcdd4]/20 shadow-lg">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <p>
                ...
                I've worked on a variety of projects ranging from personal
                portfolios to complex e-commerce platforms. I believe in
                creating websites that not only look great but also provide
                exceptional user experiences.
              </p>

              <p>
                When I'm not coding, you can find me exploring new design
                trends, diving into AI innovations, or binge-watching my
                favorite series.
              </p>
            </div>
          </div>
        ...
        <div className="absolute bottom-10 left-10 w-20 h-20">
          <div
            ...
            style={{ backgroundImage: "url('/profile/leaf.png')" }}
          ></div>
        </div>
